...
Object.assign(C.characters,{
 ...
 aelthir:{name:'Aelthir',description:'O último guardião élfico. Sua lâmina carrega o coração da geleira.',hp:8,speed:169,radius:8,weapon:'glaive',price:1200,purchaseMap:'ice',passive:'Coração glacial · +45% de dano, +12% de cadência; dash de 54 de dano base.',dashCooldown:1.85,damage:1.45,attackSpeed:1.12,range:1.1,unlock:'Libere o Santuário do Inverno e compre por 1200 de ouro',fireDash:{damage:54,radius:80,color:'#d1ffff',slow:.4,duration:2}}
});
