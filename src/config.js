(function(root){
const C={
 version:2,slots:6,maxWeaponLevel:5,contactCooldown:1.05,pickupRadius:25,checkpointSeconds:3,
 ...
 characters:{
  noctis:{name:'Noctis',description:'Uma sombra de capuz carmesim. Ágil entre as ruínas.',hp:5,speed:158,radius:8,weapon:'dagger',passive:'Passo silencioso · esquiva recarrega 15% mais rápido.',dashCooldown:2.125,damage:1,attackSpeed:1,range:1,unlocked:true},
 ...
 weapons:{
  ...
  ember:{name:'Selo das cinzas',description:'Uma explosão anunciada consome um grupo de inimigos.',kind:'area',damage:38,interval:2.8,range:220,radius:46,count:1,maxLevel:5,color:'#eea05f',icon:'✹',unlock:'Sobreviva 30 segundos na Necrópole',growth:{damage:.3,interval:.05,range:.1}},
  thorns:{name:'Coroa de espinhos',description:'Espinhos orbitais golpeiam os inimigos próximos.',kind:'orbital',damage:16,interval:1.1,range:76,count:2,maxLevel:5,color:'#ac91dc',icon:'✧',unlock:'Sobreviva 60 segundos na Necrópole',growth:{damage:.3,interval:.05,range:.06}},
 ...
 maps:{
  ...
  necropolis:{name:'Necrópole Carmesim',subtitle:'CAPÍTULO I',description:'Caminhos de pedra, árvores retorcidas e um guardião alado. Sobreviva por 3 minutos para invocá-lo.',duration:180,bossAt:180,unlocked:true,finishOnBoss:true,spawn:{x:480,y:310},bounds:{x:40,y:65,w:880,h:445},spawnInterval:1.4,minInterval:.38,enemies:['undead','stalker','brute','caster'],eliteEvery:45,obstacles:[{x:180,y:155,r:27},{x:765,y:165,r:28},{x:255,y:375,r:22},{x:720,y:400,r:24},{x:360,y:175,r:22},{x:615,y:370,r:21}],boss:{name:'Morthar · Guardião da Necrópole',hp:2400,damage:1,speed:28,r:31,size:111,asset:'dragon',gold:100,interval:3.4}}
 },
 assets:{
